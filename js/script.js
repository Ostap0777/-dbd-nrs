...
function koshukNumber() {
	...
	function removeKoshuk() {
		...
		document.querySelector('.btn-koshuk__delate').addEventListener('click', removeKoshuk)
		
		
			document.querySelector('.btn-koshuk__delate3').addEventListener('click', removeKoshuk)
		
			document.querySelector('.btn-koshuk__delate2').addEventListener('click', removeKoshuk)
